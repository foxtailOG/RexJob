...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => (
    <div className="bg-white/60 dark:bg-dark-surface/60 backdrop-blur-sm p-8 rounded-2xl shadow-lg shadow-gray-200/60 dark:shadow-black/20 border border-white/50 dark:border-slate-700/50">
        <div className="flex items-center justify-center h-16 w-16 rounded-xl bg-secondary-500 mb-6">
            {icon}
        </div>
        <h3 className="text-xl font-bold text-primary-800 dark:text-primary-100 mb-3">{title}</h3>
        <p className="text-primary-700 dark:text-primary-300 leading-relaxed">{description}</p>
    </div>
);
        ...
        <div className="animated-gradient-bg">
            ...
            <main className="container mx-auto px-6">
                <section className="py-24 md:py-32 flex flex-col justify-center items-center text-center">
                    <h1 className="text-5xl md:text-7xl font-extrabold text-primary-900 dark:text-white leading-tight">
                        Optimize Your Resume for <br />
                        <span className="text-secondary-600 dark:text-secondary-400">ATS Success</span>
                    </h1>
                    <p className="mt-6 text-lg md:text-xl text-primary-700 dark:text-primary-300 max-w-3xl">
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        ...
                        <button
                            ...
                            className="px-8 py-4 bg-white text-primary-800 font-semibold rounded-lg border border-gray-200 shadow-md shadow-gray-200/50 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-opacity-75 transition-all transform hover:scale-105 duration-300
                                       dark:bg-slate-800 dark:text-primary-100 dark:border-slate-700 dark:hover:bg-slate-700 dark:shadow-black/20 dark:focus:ring-slate-500">
                            Create New Resume
                        </button>
                    </div>
                </section>
